...
2. Эндпоинты:
    ...
    d) Экспорт списка с учетом всех фильтров и сортировок в XLS файл.</font>
    
3. <a href="/brand-all" style="color:green">Реализовать автообновление базы марок</a> и моделей, со стороннего ресурса, раз в месяц.
4. <a href="/autocomplete" style="color:green">Реализовать эндпоинт автокомплит марки</a> и выведение всех моделей этой марки.
    <font color="orange">▪ (не можу виконати, поки-що автокомпліт тільки по одному полю)</font>
    </pre>
    ...
    <ul>
        ...
        <p>
            <li>
                <a href="/list"> Список записів (+пагінація +сортування +експорт +редагування)</a> (2.b+c+d)
            </li>
        </p>
        <p>
            <li>
                <a href="/search">Пошук певних записів</a> (2.b)
            </li>
        </p>
        <hr>
        <p>
        ...
        <p>
            <li>
                <a href="/brand_export/500">Оновлювати бренди локально (по 500 шт)</a> (3)
            </li>
        </p>
        <hr>
        <p>

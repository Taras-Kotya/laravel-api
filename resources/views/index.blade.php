...
3. Реализовать авто<a href="/brand-all" style="color:green">обновление базы марок</a> и моделей, со стороннего ресурса, раз в месяц.
4. <a href="/autocomplete" style="color:green">Реализовать эндпоинт автокомплит марки</a> и выведение всех моделей этой марки.
    ...
    <ul>
        ...
        <p>
            <li>
                <a href="/brand-all">База брендов</a> (3)
            </li>
        </p>
        <p>
            <li>
